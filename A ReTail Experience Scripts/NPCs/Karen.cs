...
public class Karen : MonoBehaviour
{
    ...
    public int games_done = 0; //the amount of games done
    ...
    private void Update()
    {
        ...
        else if (is_at_selfCheckout)
        {
            ...
            else
            {
                ...
                else if(helped && games_done == 0)
                {
                    helped = false;
                    being_helped = false;
                    games_done++;
                    SCO_Light.GetComponent<SCO_Manager>().pick_new_game();
                    SCO_Light.GetComponent<SCO_Manager>().helping_NPC();
                }
